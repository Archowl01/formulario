        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-xs-12">
                ...
                <div class="form-group">
                    <label>Nombre </label>
                    <input type="text" name="name" class="form-control form" id="name" placeholder="Nombre" maxlength="30" />
                </div>
                 <div class="form-group">
                    <label>Apellido</label>
                    <input type="text" name="Ape" class="form-control form" id="Ape" placeholder="Apellido" maxlength="30"/>
                 </div>
                <div class="form-group">
                    <label>RUT </label>
                    <div class="row">                    
                        <div class="col-md-8 col-sm-8 col-xs-8 left">
                        <input type="number" class="form-control" name="rut" id="rut" placeholder="123456789" min="0" maxlength="8" />
                        </div>
